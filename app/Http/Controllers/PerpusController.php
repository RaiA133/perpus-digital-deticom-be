...
class PerpusController extends Controller
{
  ...
  public function index(Request $request)
  {
    if ($request->has('search')) {
      ...
      $perpus = Perpus::where('categorybook_id', $request->category)->with('categorybooks')->get();
    } else {
    ...
    $asd = Perpus::all();
    // dd($asd);
    $allcategorybooks = CategoryBook::all();
    return view('/user/perpus', compact('user', 'perpus', 'allcategorybooks'));
  }
