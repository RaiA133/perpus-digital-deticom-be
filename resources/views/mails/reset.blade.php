                      ...
                      <tbody>
                        <tr>
                          <td style="line-height: 24px; font-size: 16px; margin: 0;" align="left">
                            ...
                            <img class="w-16" src="{{ asset('storage/img/logokomi.png') }}" style="height: auto; line-height: 100%; outline: none; text-decoration: none; display: block; width: 64px; border-style: none; border-width: 0;" width="64">
                            <table class="s-6 w-full" role="presentation" border="0" cellpadding="0" cellspacing="0" style="width: 100%;" width="100%">
                              <tbody>
                                <tr>
                                  <td style="line-height: 24px; font-size: 24px; width: 100%; height: 24px; margin: 0;" align="left" width="100%" height="24">
                            ...
                            <div class="space-y-4">
                              <h1 class="text-4xl fw-800" style="padding-top: 0; padding-bottom: 0; font-weight: 800 !important; vertical-align: baseline; font-size: 36px; line-height: 43.2px; margin: 0;" align="left">PMII Komisariat Uninus</h1>
                              ...
                              <tbody>
                                <tr>
                                  <td style="line-height: 24px; font-size: 16px; width: 100%; border-radius: 24px; margin: 0; padding: 40px;" align="left" bgcolor="#ffffff">
                                    <h3 class="text-center mb-2" style="padding-top: 0; padding-bottom: 0; font-weight: 500; vertical-align: baseline; font-size: 28px; line-height: 33.6px; margin: 0;" align="center">Salam Pergerakan</h3>
                                    <p class="text-center text-muted mb-2" style="line-height: 24px; font-size: 16px; color: #718096; width: 100%; margin: 0;" align="center">You are receiving this email because we received a password reset request for your account. </p>
                                      ...
                                      <tbody>
                                        ...
                                        <tr>
                                          <td style="line-height: 24px; font-size: 16px; border-radius: 9999px; width: 192px; margin: 0;" align="center" bgcolor="#dc3545" width="192">
                                            <a href="https://app.bootstrapemail.com/templates" style="color: #ffffff; font-size: 16px; font-family: Helvetica, Arial, sans-serif; text-decoration: none; border-radius: 9999px; line-height: 20px; display: block; font-weight: normal; background-color: #dc3545; padding: 8px 24px; border: 1px solid #dc3545;">Reset Password</a>
                                          </td>
                                        </tr>
                                      </tbody>
                                      <tbody>
                                    ...
                                    <p style="line-height: 24px; font-size: 16px; width: 100%; margin: 0;" align="left">This password reset link will expire in 60 minutes.
                                      ...
                                      <a href="https://bootstrapemail.com" style="color: #0d6efd;"><span class="__cf_email__" data-cfemail="baf2d3caf9d5c8cafadfc2dbd7cad6df94d9d5d7">[email&#160;protected]</span></a>.</p>
