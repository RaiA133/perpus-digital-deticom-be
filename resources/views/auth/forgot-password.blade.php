              ...
              <div class="d-flex align-items-center">
                <div class="card-body p-4 p-lg-5 text-black">
                  ...
                  <form method="POST" action="{{ route('password.email') }}">
                    ...
                    <h3 class="fw-normal mb-3 text-center" style="letter-spacing: 1px;">Forget Your Password</h3>
                    <h6 class="fw-normal mb-3 text-center" style="letter-spacing: 1px;">Please Input Your Email Here!</h6>
                    ...
                    <div class="form-group mb-3">
                      <label class="font-weight-bold text-uppercase mb-3">Email Address</label>
                      <input id="email" type="email" class="form-control @error('email') is-invalid @enderror"
                          name="email" value="{{ old('email') }}" required autocomplete="email" autofocus
                          placeholder="Masukkan Alamat Email">
                    </div>

                    <div class="pt-1 d-flex justify-content-start gap-3">
