      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-info">
            <h3>MY <span> PERPUS</span></h3>
            <p>Perpustakaan digital adalah sebuah platform atau sistem yang menyediakan akses elektronik atau digital terhadap koleksi buku, artikel, jurnal, dan materi referensi lainnya<p>
          </div>
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            ...
            <p>
              ...
              <strong>Email:</strong> myperpus.digital@gmail.com<br>
            </p>
